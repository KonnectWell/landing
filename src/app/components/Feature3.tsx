      ...
      <div className="container">
        <div className="grid items-center gap-6 lg:grid-cols-2">
          ...
          <div className="relative">
            <Image alt="KonnectWell personalized support" src={finance10} className="rounded-xl" />
                ...
                <div className="max-w-md">
                  <div className="rounded-xl border border-default-200 bg-white p-6 dark:bg-default-50">
                    ...
                    <p className="mt-4 text-base">
                      Schedule a complimentary consultation to discuss your financial goals and find your perfect advisor match.
                    </p>
                  </div>
                </div>
              </div>
