...
const experts: ExpertType[] = [
  {
    ...
    description:
      'Specializing in retirement planning and wealth management for over 15 years. Sarah has helped hundreds of families achieve their financial goals through personalized investment strategies, tax-efficient portfolio optimization, and ongoing financial planning guidance. Her expertise includes tax-efficient investing, estate planning, retirement income optimization, and comprehensive financial planning services.',
    image: avatar1,
  },
  {
    name: 'David Chen',
    ...
    description:
      'David brings 12+ years of investment management and portfolio construction experience with a focus on risk management and wealth building strategies. He specializes in helping high-net-worth individuals and families build diversified investment portfolios that align with their long-term financial objectives, retirement planning goals, and investment risk tolerance through advanced portfolio optimization techniques.',
    image: avatar3,
  },
]
